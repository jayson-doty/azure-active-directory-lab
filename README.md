...
### ⚙️ Implementation Phase
* **Security Boundary Management:** Implemented Role-Based Access Control (RBAC) by provisioning explicit Security Groups (e.g., `HR_Modified`, `IT_Admins`) within the directory structure.
